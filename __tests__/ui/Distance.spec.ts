...
describe('DistanceTest', () => {
  ...
  test('can convert to float', () => {
    ...
    expect(Distance.ofKm(0).toKmInFloat()).toEqual(0);
  ...
  test('can represent distance as meters', () => {
    ...
    expect(Distance.ofKm(0).printIn('m')).toEqual('0 m');
  ...
  test('can represent distance as km', () => {
    ...
    expect(Distance.ofKm(0).printIn('km')).toEqual('0 km');
  ...
  test('can represent distance as miles', () => {
    ...
    expect(Distance.ofKm(0).printIn('miles')).toEqual('0 mi');
